...
specs:
  - label: Format
    value: Hardback & PDF
  - label: Deliverables
    value: 1 Core Book + 4 adventure zines
  - label: Status
    value: Funded — late pledges open - delivery begins October 2026
---
Final Light is a short-form survival-horror RPG set after the world has fallen apart. **You are not heroes trying to fix it. You are survivors trying to get through it.**

This isn't a game about mowing down enemies or levelling up. It's a game where tables lean into the humanity of horror, fighting the enemies without and the enemies within, and wondering who will make it to the end of the story together. Grab your backpack, it's just about all you can rely on now.

---

#### THE ZOMBIE TTRPG FOR FANS OF: *The Last of Us*, *28 Days Later*, *Train to Busan*, *The Walking Dead*, and more...

Get the full details and reserve your copy on Kickstarter. Late pledges still open. 

[++ Final Light on Kickstarter](https://www.kickstarter.com/projects/heysarahbrown/final-light-a-cinematic-short-form-survival-ttrpg?ref=72yvgd)
